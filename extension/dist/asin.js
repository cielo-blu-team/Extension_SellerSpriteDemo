  ...
  var init_modal = __esm({
    "extension/components/modal.js"() {
      ...
      <div id="ec-lens-panel-header">
        ...
        <button class="ec-lens-hdr-btn" id="ec-lens-panel-close" title="\u9589\u3058\u308B">\xD7</button>
      </div>
    ...
    ` : "";
          const tableHTML = (title, items, color2) => {
              ...
              <tr>
                ...
                <td>
                  <div class="ec-lens-percent-bar">
                    <div class="bar-track">
                      <div class="bar-fill ${color2}" style="width:${Math.min(item.percent || 0, 100)}%"></div>
                    </div>
    ...
    "extension/content-scripts/asin.js"() {
        ...
        panel.onReviewAnalysis(async (resultEl) => {
          ...
          <div style="padding:12px;background:#fff8e1;border:1px solid #ffe082;border-radius:6px;margin:8px 0;font-size:14px;line-height:1.6;">
            ...
            <button id="ec-lens-confirm-no" style="background:#e0e0e0;color:#333;border:none;padding:6px 14px;border-radius:4px;cursor:pointer;font-size:13px;">\u30AD\u30E3\u30F3\u30BB\u30EB</button>
              ...
              resultEl.querySelector("#ec-lens-confirm-yes").addEventListener("click", () => resolve2(true));
              resultEl.querySelector("#ec-lens-confirm-no").addEventListener("click", () => resolve2(false));
            });
            if (!confirmed) {
      ...
      async function fetchAllReviews(asin, onProgress) {
        ...
        while (page <= MAX_PAGES && (positive.length < MAX_PER_CATEGORY || negative.length < MAX_PER_CATEGORY)) {
          ...
          if (res.length > 0) {
            for (const r of res) {
              if (r.rating >= 4 && positive.length < MAX_PER_CATEGORY) {
                positive.push(r);
                anyAdded = true;
              } else if (r.rating <= 2 && negative.length < MAX_PER_CATEGORY) {
                negative.push(r);
                anyAdded = true;
              }
            }
